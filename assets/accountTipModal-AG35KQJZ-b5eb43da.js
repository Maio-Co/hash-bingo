import{U as g,k as u,o,X as b,Z as w,B as r}from"./index-d9a9a9ca.js";import{u as x}from"./useTranslation-97073332.js";var f=`.ant-modal-content .ant-modal-footer {
  display: none;
}
...
`,v=({modal:l})=>{var e;let{visible:c,confirm:a}=l,{t}=x(),{setPaymentPassword:i,showAccountTipModal:n,modalOptions:s}=g(),{authCoreModal:d}=u(),p=()=>{n({visible:!1}),i()},m=()=>{a==null||a(),n({visible:!1})};return o.createElement(o.Fragment,null,o.createElement("style",null,f),o.createElement(b,{open:c,closable:!1,centered:!0,okButtonProps:{style:{display:"none"}},cancelButtonProps:{style:{display:"none"}},width:"90%",getContainer:()=>d.rootBody},o.createElement("div",{className:"wrong-password-content"},o.createElement(w,{className:"close-icon",onClick:()=>n({visible:!1})}),o.createElement("h3",{className:"modal-title m-margin-top-40"},t("account.account_modal1_title")),o.createElement("div",{className:"tip"},t("account.account_modal1_tip")),o.createElement(r,{className:"btn",onClick:p},t("account.account_modal1_btn1")),((e=s.promptSettingConfig)==null?void 0:e.promptPaymentPasswordSettingWhenSign)!==3&&o.createElement(r,{className:"btn cancel",onClick:m},t("account.account_modal1_btn2")))))},k=v;export{k as default};
